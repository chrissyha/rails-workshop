...
class VacationsControllerTest < ActionController::TestCase
  ...
  test "should create vacation" do
    assert_difference('Vacation.count') do
      post :create, vacation: { description: @vacation.description, image_url: @vacation.image_url, name: @vacation.name, price: @vacation.price }
    end
  ...
  test "should update vacation" do
    patch :update, id: @vacation, vacation: { description: @vacation.description, image_url: @vacation.image_url, name: @vacation.name, price: @vacation.price }
    assert_redirected_to vacation_path(assigns(:vacation))
  end
